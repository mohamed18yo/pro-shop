...
import {
  ...
  import {  Input, FormBox,ErrorMsg } from "../../Gust/auth/login/login.style";

import{SignupSection} from '../../Gust/auth/signup/signup.style';
  import { useDispatch ,useSelector} from "react-redux";
import { useEffect } from "react";

import {GetUserDataForUpdateProfile, UpdateProfileAction} from '../../../redux/user/userAction';
...
function UpdateProfile(){
    ...
    return(
      state.userDetailes.isLoading?(<SpinnerContainer/>):(
        <SectionRole>
        <IneerSection>
          <SignupSection>
            <FormBox>
